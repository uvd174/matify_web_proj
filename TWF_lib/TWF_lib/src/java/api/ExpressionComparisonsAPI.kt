...
import config.ComparisonSettings
...
fun compareWithoutSubstitutions(
        ...
        compiledConfiguration: CompiledConfiguration = CompiledConfiguration(functionConfiguration = functionConfiguration, comparisonSettings = comparisonSettings)
